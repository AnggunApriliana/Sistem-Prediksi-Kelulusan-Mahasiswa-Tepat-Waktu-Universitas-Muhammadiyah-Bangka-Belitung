...
# ==========================================
# 4. PETUNJUK VISUAL (LANGKAH DEMI LANGKAH)
# ==========================================
...
# Menggunakan 5 kolom untuk menyertakan langkah unduh hasil
...
with s1:
    ...
    <div class="step-box">
        ...
        <div class="step-title">1. Unduh Template</div>
        <div class="step-desc">Klik tombol <b>"UNDUH TEMPLATE"</b> untuk mendapatkan format file Excel kosong.</div>
    </div>
    """, unsafe_allow_html=True)
...
with s2:
    ...
    <div class="step-box">
        <div class="step-icon">📝</div>
        <div class="step-title">2. Isi Data</div>
        <div class="step-desc">Buka file Excel, isi data mahasiswa aktif khusus semester 1 sampai dengan semester 8.</div>
    </div>
    """, unsafe_allow_html=True)
...
with s3:
    ...
    <div class="step-box">
        <div class="step-icon">📤</div>
        <div class="step-title">3. Unggah File</div>
        <div class="step-desc">Klik kotak <b>"Upload"</b> lalu pilih file Excel yang sudah diisi datanya secara lengkap.</div>
    </div>
    """, unsafe_allow_html=True)
...
with s4:
    ...
    <div class="step-box">
        ...
        <div class="step-title">4. Proses</div>
        <div class="step-desc">Klik tombol <b>"MULAI PROSES PREDIKSI"</b> untuk menganalisis data secara otomatis.</div>
    </div>
    """, unsafe_allow_html=True)
...
with s5:
    ...
    <div class="step-box">
        <div class="step-icon">📄</div>
        <div class="step-title">5. Unduh Hasil</div>
        <div class="step-desc">Setelah hasil muncul, klik tombol <b>"Download File Excel"</b> untuk menyimpan laporan prediksi.</div>
    </div>
    """, unsafe_allow_html=True)
...
with g1:
    ...
    <div class="guide-card">
        ...
        <p><span class="step-number">1</span> Unduh <b>Template Excel</b>.</p>
        ...
        <div style="background-color: #fff4f4; padding: 12px; border-radius: 10px; border: 1px solid #fecaca; margin-top: 15px;">
            <p style="color: #b91c1c; font-size: 0.9rem; margin-bottom: 0;">
                <b>Note:</b> Sistem ini hanya bisa memprediksi mahasiswa aktif dari semester 1 sampai semester 8. Untuk mahasiswa semester 9 tidak bisa diprediksi menggunakan sistem ini 🙏. 
            </p>
        </div>
    </div>
    """, unsafe_allow_html=True)
    ...
    try:
        ...
        if st.button("🚀 MULAI PROSES PREDIKSI"):
            with st.spinner("Sedang memprediksi..."):
                ...
                # --- Unduh Hasil (Kustomisasi Tabel Excel) ---
                st.markdown("---")
                ...
                with pd.ExcelWriter(excel_data, engine='xlsxwriter') as writer:
                    ...
                    data_format = workbook.add_format({
                        'border': 1, 'align': 'left', 'valign': 'middle'
                    })
                    ...
                    for row in range(1, len(df_final) + 1):
                        for col in range(len(df_final.columns)):
                            worksheet.write(row, col, df_final.iloc[row-1, col], data_format)
